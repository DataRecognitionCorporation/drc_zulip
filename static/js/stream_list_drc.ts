import { has_recent_activity } from "./stream_sort"
...
import * as stream_list_sort from "./stream_sort";
                    ...
                    for(let sub_subfolder of subfolder.subfolders) {
                        ...
                        for(let row of all_rows){
                            if(stream_counts.has(row.sub.stream_id)) {
                                ...
                                sub_subfolder_count = sub_subfolder_count + stream;
                            }
                        }
